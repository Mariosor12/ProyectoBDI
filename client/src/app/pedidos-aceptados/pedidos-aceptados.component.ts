...
@Component({
  ...
  templateUrl: './pedidos-aceptados.component.html',
  styleUrls: ['./pedidos-aceptados.component.css']
})
export class PedidosAceptadosComponent implements OnInit {
  ...
  getAliados(){
    // console.log(this.contrato[0].productor);
    this.sg.getonePedidoAceptado(this.contrato[0].productor).subscribe(
      res => {
        this.pedidos = res;
